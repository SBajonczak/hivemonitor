...
void onHomieEvent(const HomieEvent &event)
{
  ...
  case HomieEventType::NORMAL_MODE:
    ...
    temperature1 = temperatures.getTemperature(0);
    weight = scaledevice.getWeight(temperature1);
    voltage = batteryProcessor.getVolt();
...
void setup()
{
  ...
  case STATE_CONNECT_WIFI:
    ...
    scaledevice.setup(kilogramDividerSetting.get(), weightOffsetSetting.get(), calibrationTemperatureSetting.get(), calibrationFactorSetting.get());
